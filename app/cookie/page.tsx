    ...
    <>
      ...
      <section className="section" style={{paddingTop:'0'}}>
        <div style={{display:'flex',flexDirection:'column',gap:'28px',fontSize:'15px',lineHeight:'1.7',color:'#ccc'}}>
          ...
          <div>
            <h2 style={{fontFamily:'var(--font-display)',fontSize:'20px',fontWeight:800,textTransform:'uppercase',color:'var(--white)',marginBottom:'10px'}}>Cosa sono i cookie</h2>
          ...
          <div>
            <h2 style={{fontFamily:'var(--font-display)',fontSize:'20px',fontWeight:800,textTransform:'uppercase',color:'var(--white)',marginBottom:'10px'}}>Cookie utilizzati da questo sito</h2>
          ...
          <div>
            <h2 style={{fontFamily:'var(--font-display)',fontSize:'20px',fontWeight:800,textTransform:'uppercase',color:'var(--white)',marginBottom:'10px'}}>Come disabilitare i cookie</h2>
          ...
          <div>
            <h2 style={{fontFamily:'var(--font-display)',fontSize:'20px',fontWeight:800,textTransform:'uppercase',color:'var(--white)',marginBottom:'10px'}}>Opt-out Google Ads</h2>
          ...
          <div>
            <h2 style={{fontFamily:'var(--font-display)',fontSize:'20px',fontWeight:800,textTransform:'uppercase',color:'var(--white)',marginBottom:'10px'}}>Contatti</h2>
