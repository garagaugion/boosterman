  ...
  return (
    <>
      ...
      <div className="page-hero">
        ...
        <p style={{color:'#aaa',fontSize:'15px',lineHeight:'1.6'}}>Le domande che ci fanno più spesso. Non trovi la risposta? Scrivici su WhatsApp.</p>
      </div>
      <section className="section" style={{paddingTop:'0'}}>
        ...
        <div style={{marginTop:'28px',background:'rgba(255,214,0,0.08)',border:'1px solid rgba(255,214,0,0.25)',borderRadius:'12px',padding:'20px'}}>
          <div style={{fontFamily:'var(--font-display)',fontSize:'18px',fontWeight:800,textTransform:'uppercase',marginBottom:'8px'}}>Hai altre domande?</div>
          <p style={{fontSize:'14px',color:'#aaa',marginBottom:'16px'}}>Scrivici su WhatsApp o chiamaci direttamente. Rispondiamo sempre.</p>
