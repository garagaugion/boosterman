...
function ZoneGroup({ title, zones }: { title: string; zones: string[] }) {
  return (
    <div style={{marginBottom:'28px'}}>
      <h3 style={{fontFamily:'var(--font-display)',fontSize:'16px',fontWeight:800,textTransform:'uppercase',letterSpacing:'2px',color:'var(--yellow)',marginBottom:'12px'}}>{title}</h3>
  ...
  return (
    <>
      ...
      <div className="page-hero">
        ...
        <p style={{color:'#aaa',fontSize:'15px',lineHeight:'1.6'}}>Operiamo su tutta Roma e provincia. Tempo medio di arrivo 20-40 minuti.</p>
      </div>
      <section className="section" style={{paddingTop:'0'}}>
        ...
        <div style={{marginBottom:'32px'}}>
          <h2 style={{fontFamily:'var(--font-display)',fontSize:'16px',fontWeight:800,textTransform:'uppercase',letterSpacing:'2px',color:'var(--yellow)',marginBottom:'14px'}}>
