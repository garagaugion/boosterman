...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Pronto intervento elettrauto a Ciampino: batteria scarica, apertura auto, gomma forata. H24, 7 giorni su 7.',
  ...
  return (
    <>
      ...
      <div className="page-hero">
        ...
        <h1 className="section-title">Elettrauto H24<br /><span className="text-yellow">Ciampino</span></h1>
        <p style={{color:'#aaa',fontSize:'15px',lineHeight:'1.6'}}>
          Pronto intervento elettrauto a Ciampino (Provincia di Roma - Sud-Est). Arriviamo in 20-40 minuti, H24, 7 giorni su 7.
        </p>
      ...
      <section className="section" style={{paddingTop:'0'}}>
        ...
        <div style={{display:'flex',flexDirection:'column',gap:'12px',marginBottom:'32px'}}>
          <a href="tel:+393270447124" className="btn-primary" style={{fontSize:'18px',padding:'18px'}}>
            📞 Chiama ora — Arriviamo a Ciampino
          </a>
          <a
            href="https://wa.me/393270447124?text=Ciao%20BOOSTERMAN%2C%20ho%20bisogno%20di%20assistenza%20a%20Ciampino."
            target="_blank" rel="noopener noreferrer"
            className="btn-whatsapp"
          >
            💬 WhatsApp H24 — Ciampino
          </a>
        </div>
        ...
        <div className="info-card" style={{marginBottom:'28px',background:'rgba(255,214,0,0.08)',border:'1px solid rgba(255,214,0,0.25)'}}>
          ...
          <div>
            <div className="info-title">Copertura Ciampino</div>
            <div className="info-text">Ciampino ospita il secondo aeroporto di Roma. Molte auto lasciate a lungo nei parcheggi dell'aeroporto sviluppano problemi di batteria. Zona anche industriale.</div>
          </div>
        </div>

        {/* Servizi */}
        <h2 className="section-title" style={{fontSize:'26px',marginBottom:'16px'}}>
          Cosa facciamo a <span className="text-yellow">Ciampino</span>
        </h2>
        <div style={{display:'flex',flexDirection:'column',gap:'10px',marginBottom:'28px'}}>
          {[
            ...
            { icon:'🛞', title:'Gomma forata', desc:'Montiamo il tuo ruotino o la ruota di scorta. Quando possibile ripariamo sul posto a Ciampino. Da €49.' },
        ...
        <div className="info-card" style={{marginBottom:'28px',background:'rgba(255,255,255,0.04)'}}>
          ...
          <div>
            <div className="info-title">Come raggiungiamo Ciampino</div>
            <div className="info-text">Interveniamo nei parcheggi dell'aeroporto di Ciampino, nel comune e nelle zone industriali circostanti. Siamo abituati alle emergenze 'rientro dal viaggio, auto non parte'.</div>
          </div>
        </div>
        ...
        <div className="info-card" style={{marginBottom:'28px'}}>
          <span className="info-icon">🚗</span>
          <div>
            <div className="info-title">Veicoli più comuni a Ciampino</div>
            <div className="info-text">
              A Ciampino interveniamo spesso su auto di ogni tipo, auto lasciate nei parcheggi aeroportuali. Trattiamo auto di qualsiasi marca e modello.
            </div>
          </div>
        </div>
        ...
        <div style={{marginBottom:'28px'}}>
          ...
          <div className="zone-grid">
            <div className="zone-item">Frascati</div>
            <div className="zone-item">Marino</div>
            <div className="zone-item">Grottaferrata</div>
            <div className="zone-item">Appia</div>
          </div>
        </div>
        ...
        <div className="local-seo-content" style={{marginBottom:'28px'}}>
          <h2 className="section-title" style={{fontSize:'24px',marginBottom:'14px'}}>
            Intervento elettrauto a <span className="text-yellow">Ciampino</span>: cosa sapere
          </h2>
          <div className="info-card" style={{marginBottom:'12px'}}>
            ...
            <div>
              ...
              <div className="info-text">
                In condizioni normali interveniamo a Ciampino in circa 20-40 minuti. Di notte, nei festivi o in caso di traffico intenso il tecnico conferma sempre il tempo stimato prima della partenza.
              </div>
            </div>
          </div>
          <div className="info-card" style={{marginBottom:'12px'}}>
            ...
            <div>
              ...
              <div className="info-text">
                Copriamo Aeroporto di Ciampino, Via Appia Nuova, Via dei Laghi e zona stazione. Se non conosci l&apos;indirizzo preciso, puoi usare il pulsante SOS GPS o inviare un punto di riferimento su WhatsApp.
              </div>
            </div>
          </div>
          <div className="info-card" style={{marginBottom:'12px'}}>
            ...
            <div>
              ...
              <div className="info-text">
                Il servizio è pensato per parcheggi aeroporto, aree residenziali, noleggi e strade provinciali. Interveniamo su auto, SUV, furgoni e veicoli commerciali, anche quando il mezzo è fermo sotto casa o in un garage accessibile.
              </div>
            </div>
          </div>
          <div className="info-card" style={{marginBottom:'12px',background:'rgba(255,214,0,0.06)',border:'1px solid rgba(255,214,0,0.20)'}}>
            ...
            <div>
              ...
              <div className="info-text">
                Oltre a Ciampino, copriamo anche Anagnina, Morena, Marino, Appia e Castelli Romani. Se sei al confine tra due quartieri, chiamaci: il tecnico più vicino verifica subito la disponibilità.
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="local-faq" style={{marginBottom:'28px'}}>
          <h2 className="section-title" style={{fontSize:'24px',marginBottom:'14px'}}>
            Domande frequenti a <span className="text-yellow">Ciampino</span>
          </h2>
          <div style={{display:'flex',flexDirection:'column',gap:'10px'}}>
            <div className="info-card">
              <span className="info-icon">❓</span>
              <div>
                <div className="info-title">Intervenite a Ciampino anche di notte?</div>
