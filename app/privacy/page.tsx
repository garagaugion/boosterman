  ...
  return (
    <>
      ...
      <div className="page-hero">
        ...
        <p style={{color:'#aaa',fontSize:'13px'}}>Ultimo aggiornamento: giugno 2025</p>
      </div>
      <section className="section" style={{paddingTop:'0'}}>
        <div style={{display:'flex',flexDirection:'column',gap:'28px',fontSize:'15px',lineHeight:'1.7',color:'#ccc'}}>

          <div>
            <h2 style={{fontFamily:'var(--font-display)',fontSize:'20px',fontWeight:800,textTransform:'uppercase',color:'var(--white)',marginBottom:'10px'}}>1. Titolare del trattamento</h2>
          ...
          <div>
            <h2 style={{fontFamily:'var(--font-display)',fontSize:'20px',fontWeight:800,textTransform:'uppercase',color:'var(--white)',marginBottom:'10px'}}>2. Dati raccolti</h2>
          ...
          <div>
            <h2 style={{fontFamily:'var(--font-display)',fontSize:'20px',fontWeight:800,textTransform:'uppercase',color:'var(--white)',marginBottom:'10px'}}>3. Finalità e base giuridica</h2>
          ...
          <div>
            <h2 style={{fontFamily:'var(--font-display)',fontSize:'20px',fontWeight:800,textTransform:'uppercase',color:'var(--white)',marginBottom:'10px'}}>4. Conservazione dei dati</h2>
          ...
          <div>
            <h2 style={{fontFamily:'var(--font-display)',fontSize:'20px',fontWeight:800,textTransform:'uppercase',color:'var(--white)',marginBottom:'10px'}}>5. Condivisione dei dati</h2>
          ...
          <div>
            <h2 style={{fontFamily:'var(--font-display)',fontSize:'20px',fontWeight:800,textTransform:'uppercase',color:'var(--white)',marginBottom:'10px'}}>6. Cookie</h2>
            <p>Per i dettagli sull'utilizzo dei cookie, consultare la <a href="/cookie" style={{color:'var(--yellow)'}}>Cookie Policy</a>.</p>
          </div>

          <div>
            <h2 style={{fontFamily:'var(--font-display)',fontSize:'20px',fontWeight:800,textTransform:'uppercase',color:'var(--white)',marginBottom:'10px'}}>7. Diritti dell'interessato</h2>
          ...
          <div>
            <h2 style={{fontFamily:'var(--font-display)',fontSize:'20px',fontWeight:800,textTransform:'uppercase',color:'var(--white)',marginBottom:'10px'}}>8. Reclami</h2>
