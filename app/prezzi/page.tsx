  ...
  return (
    <>
      ...
      <div className="page-hero">
        ...
        <p style={{color:'#aaa',fontSize:'15px',lineHeight:'1.6',marginBottom:'8px'}}>
      ...
      <section className="section" style={{paddingTop:'0'}}>
        ...
        <div style={{marginTop:'32px'}}>
          <h2 className="section-title" style={{fontSize:'28px',marginBottom:'16px'}}>Come funziona il preventivo</h2>
          <div style={{display:'flex',flexDirection:'column',gap:'12px'}}>
            {[
              ...
              <div key={s.n} className="info-card">
                <div style={{width:'36px',height:'36px',borderRadius:'50%',background:'var(--yellow)',color:'var(--black)',fontFamily:'var(--font-display)',fontWeight:900,fontSize:'18px',display:'flex',alignItems:'center',justifyContent:'center',flexShrink:0}}>{s.n}</div>
                <div>
